...
class MessageFilter {
    ...
    public static String serverTagsFilter(String message) {
        return message.replaceAll("\\{Server\\}", HUB.getInstace.getServer().getName())
                ...
                .replaceAll("\\{MaxMemory\\}", String.valueOf(Runtime.getRuntime().maxMemory()/(1024 * 1024))+"MB")
                .replaceAll("\\{AllocatedMemory\\}", String.valueOf(Runtime.getRuntime().totalMemory()/(1024 * 1024))+"MB")
                .replaceAll("\\{FreeMemory\\}", String.valueOf(Runtime.getRuntime().freeMemory()/(1024 * 1024))+"MB")
